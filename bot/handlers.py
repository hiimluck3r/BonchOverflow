...
async def rules(message: types.Message):
    ruleString = f"<b>Пользуясь ботом, Вы добровольно согашаетесь с соблюдением нижеперечисленных правил.</b>\n\n" \
                 f"* Пользуясь ботом, Вы добровольно согашаетесь с соблюдением нижеперечисленных правил.\n" \
                 f"* Вопросы и ответы не должны содержать спам или рекламу в любом виде.\n" \
                 f"* Запрещено целенаправленно размещать заведомо ложную информацию. Запрещены любые целенаправленные действия, способные привести к нарушению работы бота.\n\n" \
